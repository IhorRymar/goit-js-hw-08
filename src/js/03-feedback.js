...
function onTextareaInput(e) {
  ...
  localStorage.setItem(STORAGE_KEY, JSON.stringify(lclStrgObj));
}
...
function populateForm() {
  try {
    const verifyForm = JSON.parse(localStorage.getItem(STORAGE_KEY)) || '';
    if (verifyForm) {
      refs.input.value = verifyForm.email;
      refs.textarea.value = verifyForm.message;
    }
  } catch {
    console.log('Error!');
  }
